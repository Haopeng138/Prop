...
public class Libreria {
     ...
     * @param cont El contenido del documento a crear
     */
    public void createDocumento(String aut, String tit, String cont) {
        if (aut == "") {
        ...
        Documento documento = new Documento(aut, tit, cont);
