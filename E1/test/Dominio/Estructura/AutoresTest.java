...
public class AutoresTest {
    ...
    public void addTitleToAutor() {
        ...
        /*
         * Añadir titulos o autores vacios se gestiona desde arriba en el controlador de
         * documentos.
         * No pude llegar hasta esta funcion un titulo vacio!
         * 
    ...
    public void getDocumentIdx() throws Exception {
        ...
        try {
            ...
            assertEquals("No se ha detecatado que no tiene el titulo", "Titulo no encontrado", e.getMessage());
        }
    }
