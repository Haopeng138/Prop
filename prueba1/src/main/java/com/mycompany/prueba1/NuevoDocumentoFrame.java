 ...
 * @author linhaopeng
 */
public class NuevoDocumentoFrame extends javax.swing.JFrame {

    /**
     * Creates new form NewDocument
     */
    public NuevoDocumentoFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        NombreAutor.setText("jTextField1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoDocumentoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoDocumentoFrame().setVisible(true);
            }
        });
    }
